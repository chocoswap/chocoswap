...
contract ChocoTokenWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        Choco.safeTransferFrom(msg.sender, address(this), amount);
    }

    function withdraw(uint256 amount) public virtual {
        _totalSupply = _totalSupply.sub(amount);
        _balances[msg.sender] = _balances[msg.sender].sub(amount);
        Choco.safeTransfer(msg.sender, amount);
    }
}

contract ChocoMintReward is ChocoTokenWrapper {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    uint256 public constant INIT_REWARD = 1500 * 1e18;
    ...
    constructor(address _admin, address _btoken) {
        admin = _admin;
        Choco = IERC20(_btoken);
